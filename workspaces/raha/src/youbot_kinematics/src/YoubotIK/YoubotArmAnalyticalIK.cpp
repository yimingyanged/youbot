...
void
YoubotArmAnalyticalIK::getSolverInfo(
    moveit_msgs::KinematicSolverInfo &info)
{
  info = _solver_info;
}

KDL::JntArray YoubotArmAnalyticalIK::ik(const KDL::Frame& g0,
...
KDL::Frame YoubotArmAnalyticalIK::ProjectGoalOrientationIntoArmSubspace(const KDL::Frame &goal) const
{
