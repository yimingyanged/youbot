 ...
 */
class ChainIkSolverPos_NR_JL_Mimic_upgrade : public ChainIkSolverPos
{
public:
  /**
   ...
   * @return
   */
  ChainIkSolverPos_NR_JL_Mimic_upgrade(const Chain& chain,const JntArray& q_min, const JntArray& q_max,
      ChainFkSolverPos& fksolver,ChainIkSolverVel& iksolver,unsigned int maxiter=100,double eps=1e-6,
      kdl_kinematics_plugin::IKType ik_type_=kdl_kinematics_plugin::IKPositionOrientation6D);

  ~ChainIkSolverPos_NR_JL_Mimic_upgrade();
