...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'youbot_manipulator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yiming/ros_workspace/youbot/workspaces/yiming/install/${idir}'.  Ask the maintainer 'yiming <yiming@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  _pack_libraries_with_build_configuration(youbot_manipulator_LIBRARIES ${youbot_manipulator_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${youbot_manipulator_dep}_LIBRARIES})
  _list_append_deduplicate(youbot_manipulator_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(youbot_manipulator_LIBRARIES ${youbot_manipulator_LIBRARIES})
