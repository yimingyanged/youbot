...
if("FALSE" STREQUAL "TRUE")
  set(youbot_base_ik_moveit_SOURCE_PREFIX /home/yiming/ros_workspace/youbot/workspaces/yiming/src/youbot_base_ik_moveit)
  set(youbot_base_ik_moveit_DEVEL_PREFIX /home/yiming/ros_workspace/youbot/workspaces/yiming/devel)
  ...
  set(youbot_base_ik_moveit_INSTALL_PREFIX /home/yiming/ros_workspace/youbot/workspaces/yiming/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'youbot_base_ik_moveit' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yiming/ros_workspace/youbot/workspaces/yiming/install/${idir}'.  Ask the maintainer 'MoveIt Setup Assistant <assistant@moveit.ros.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  _pack_libraries_with_build_configuration(youbot_base_ik_moveit_LIBRARIES ${youbot_base_ik_moveit_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${youbot_base_ik_moveit_dep}_LIBRARIES})
  _list_append_deduplicate(youbot_base_ik_moveit_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(youbot_base_ik_moveit_LIBRARIES ${youbot_base_ik_moveit_LIBRARIES})
