...
(cl:defmethod cl:initialize-instance :after ((m <GetInfo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetInfo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name image_cache-srv:<GetInfo-request> is deprecated: use image_cache-srv:GetInfo-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <GetInfo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_cache-srv:name-val is deprecated.  Use image_cache-srv:name instead.")
  (name m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetInfo-request>)))
  ...
  "8d4899b31d4063516f6baa20380fcdc1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetInfo-request)))
  "Returns md5sum for a message object of type 'GetInfo-request"
  "8d4899b31d4063516f6baa20380fcdc1")
...
(cl:defmethod cl:initialize-instance :after ((m <GetInfo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetInfo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name image_cache-srv:<GetInfo-response> is deprecated: use image_cache-srv:GetInfo-response instead.")))

(cl:ensure-generic-function 'info_msg-val :lambda-list '(m))
(cl:defmethod info_msg-val ((m <GetInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_cache-srv:info_msg-val is deprecated.  Use image_cache-srv:info_msg instead.")
  (info_msg m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GetInfo-response>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'info_msg) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GetInfo-response>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'info_msg) istream)
  msg
)
