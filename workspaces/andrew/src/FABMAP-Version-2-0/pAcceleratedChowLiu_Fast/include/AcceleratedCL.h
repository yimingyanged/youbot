...
//                    2008/3/12                         *
//                                                      *
// This code implements Meila's algorithm for efficient *
// Chow Liu tree computation from sparse binary data.   *
// To understand what's going on, read:                 *
//                                                      *
// "An Accelerated Chow and Liu Algorithm: Fitting      *
//  Tree Distributions to High-Dimensional Sparse Data" *
//  Marina Meila, ICML, 1999                            *
//                                                      *
//  also see Meila's thesis.                            *
//                                                      *
//*******************************************************
...
class AcceleratedCLCalculator
{
    ...
    private:
        ...
        vector<vector<NodeID> > m_V0bar;            //V0bar(u) initially has the same entires as C(u)
                                                    //Each entry is sorted in decreasing order of N_v
...
inline MutualInfo GetMutualInfo(const unsigned int &nN, const unsigned int &nNu, const unsigned int &nNv, const unsigned int &nNuv)
{
    ...
    double base_conversion = 1.0/log10(2.0);    //base conversion isn't strictly necessary, but it's useful to have mutual info in units of bits
