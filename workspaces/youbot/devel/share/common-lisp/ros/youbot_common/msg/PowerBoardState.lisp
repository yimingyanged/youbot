...
(cl:in-package youbot_common-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <PowerBoardState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PowerBoardState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youbot_common-msg:<PowerBoardState> is deprecated: use youbot_common-msg:PowerBoardState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PowerBoardState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youbot_common-msg:header-val is deprecated.  Use youbot_common-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <PowerBoardState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youbot_common-msg:name-val is deprecated.  Use youbot_common-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'serial_num-val :lambda-list '(m))
(cl:defmethod serial_num-val ((m <PowerBoardState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youbot_common-msg:serial_num-val is deprecated.  Use youbot_common-msg:serial_num instead.")
  (serial_num m))

(cl:ensure-generic-function 'input_voltage-val :lambda-list '(m))
(cl:defmethod input_voltage-val ((m <PowerBoardState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youbot_common-msg:input_voltage-val is deprecated.  Use youbot_common-msg:input_voltage instead.")
  (input_voltage m))

(cl:ensure-generic-function 'master_state-val :lambda-list '(m))
(cl:defmethod master_state-val ((m <PowerBoardState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youbot_common-msg:master_state-val is deprecated.  Use youbot_common-msg:master_state instead.")
  (master_state m))

(cl:ensure-generic-function 'circuit_state-val :lambda-list '(m))
(cl:defmethod circuit_state-val ((m <PowerBoardState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youbot_common-msg:circuit_state-val is deprecated.  Use youbot_common-msg:circuit_state instead.")
  (circuit_state m))

(cl:ensure-generic-function 'circuit_voltage-val :lambda-list '(m))
(cl:defmethod circuit_voltage-val ((m <PowerBoardState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youbot_common-msg:circuit_voltage-val is deprecated.  Use youbot_common-msg:circuit_voltage instead.")
  (circuit_voltage m))

(cl:ensure-generic-function 'run_stop-val :lambda-list '(m))
(cl:defmethod run_stop-val ((m <PowerBoardState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youbot_common-msg:run_stop-val is deprecated.  Use youbot_common-msg:run_stop instead.")
  (run_stop m))

(cl:ensure-generic-function 'wireless_stop-val :lambda-list '(m))
(cl:defmethod wireless_stop-val ((m <PowerBoardState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youbot_common-msg:wireless_stop-val is deprecated.  Use youbot_common-msg:wireless_stop instead.")
  (wireless_stop m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PowerBoardState>)))
  ...
  (cl:format cl:nil "# This message communicates the state of the PR2's power board.~%int8 STATE_NOPOWER=0~%int8 STATE_STANDBY=1~%int8 STATE_PUMPING=2~%int8 STATE_ON=3~%~%# Preferred over STATE_ON, keeping STATE_ON for backcompat~%int8 STATE_ENABLED=3~%~%int8 STATE_DISABLED=4~%~%int8 MASTER_NOPOWER=0~%int8 MASTER_STANDBY=1~%int8 MASTER_ON=2~%int8 MASTER_OFF=3~%int8 MASTER_SHUTDOWN=4~%~%Header header~%# Name with serial number~%string name~%# Serial number for this board's message~%uint32 serial_num~%# Input voltage to power board~%float64 input_voltage~%~%# Master States:~%# MASTER_NOPOWER, MASTER_STANDBY, MASTER_ON, MASTER_OFF, MASTER_SHUTDOWN~%~%# The master state machine's state in the powerboard~%int8 master_state~%~%# Circuit States:~%# STATE_NOPOWER, STATE_STANDBY, STATE_PUMPING, STATE_ON, STATE_DISABLED~%~%# One of the above states~%int8[3] circuit_state~%# Output voltage of each circuit~%float64[3] circuit_voltage~%~%# True if robot should be enabled~%#Note - if the wireless run-stop is hit, this will be unobservable~%bool run_stop~%bool wireless_stop~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PowerBoardState)))
  "Returns full string definition for message of type 'PowerBoardState"
  (cl:format cl:nil "# This message communicates the state of the PR2's power board.~%int8 STATE_NOPOWER=0~%int8 STATE_STANDBY=1~%int8 STATE_PUMPING=2~%int8 STATE_ON=3~%~%# Preferred over STATE_ON, keeping STATE_ON for backcompat~%int8 STATE_ENABLED=3~%~%int8 STATE_DISABLED=4~%~%int8 MASTER_NOPOWER=0~%int8 MASTER_STANDBY=1~%int8 MASTER_ON=2~%int8 MASTER_OFF=3~%int8 MASTER_SHUTDOWN=4~%~%Header header~%# Name with serial number~%string name~%# Serial number for this board's message~%uint32 serial_num~%# Input voltage to power board~%float64 input_voltage~%~%# Master States:~%# MASTER_NOPOWER, MASTER_STANDBY, MASTER_ON, MASTER_OFF, MASTER_SHUTDOWN~%~%# The master state machine's state in the powerboard~%int8 master_state~%~%# Circuit States:~%# STATE_NOPOWER, STATE_STANDBY, STATE_PUMPING, STATE_ON, STATE_DISABLED~%~%# One of the above states~%int8[3] circuit_state~%# Output voltage of each circuit~%float64[3] circuit_voltage~%~%# True if robot should be enabled~%#Note - if the wireless run-stop is hit, this will be unobservable~%bool run_stop~%bool wireless_stop~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
